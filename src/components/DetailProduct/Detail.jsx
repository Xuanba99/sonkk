                ...
                <Menu />
                {
                    this.state.products.map((product, key) => {
                        ...
                        if (product._id === IDproduct) {
                           ...
                           return <div className="detail-body" key={key}>
                                ...
                                <Row className="detail-product-main">
                                    ...
                                    <Col span={9} className="sidebardetail">
                                        ...
                                        <h1 className="price">{this.format_currency(product.price)}</h1>
                                      ...
                                      <form onSubmit={this.handleSubmit}>
                                           ...
                                           <input type="hidden"   name="txtID" ref="txtID" value={product._id}/> 
                                           <Link className="text-btnmuangay" to={"/gio-hang/"+product._id}> <input type="submit"    className="btnbuy-addtocart"  value="MUA NGAY"/></Link>   
                                    ...
                                    <h3>Trong hộp có:</h3>
                                    <p><Icon className="iconcamket" type="gift" /><a> Máy, Sạc, Cáp, Tai nghe, Sách hướng dẫn</a></p>
                                    <h3>Techphone cam kết:</h3>
                                    <p><Icon className="iconcamket" type="gift" /> Hàng chính hãng</p>
                                    <p> <Icon className="iconcamket" type="check" /> Bảo hành 12 Tháng chính hãng</p>
                                    <p> <Icon className="iconcamket" type="car"/> Giao hàng miễn phí toàn quốc trong 60 phút</p>
                                    <p> <Icon className="iconcamket" type="heat-map" /> Bảo hành nhanh tại FPT Shop trên toàn quốc</p>
                                    <p><Icon type="dollar" className="iconcamket" /> Hoàn tiền 200% nếu máy nấu</p>
